  ...
  render() {
    return (
      ...
      >
        ...
        <input type="checkbox" onChange={(e) => this.props.isCheckboxed(this.props.key, e.target.checked)} />
        {this.props.todo.text}
        <div className="iconsConteiner">
          <AiFillEdit className="check" style={{marginRight: 5 }} onClick={() => this.props.edit(this.props.text) }></AiFillEdit>
          <RiCloseCircleLine
            className="check"
            style={{ marginRight: 5 }}
